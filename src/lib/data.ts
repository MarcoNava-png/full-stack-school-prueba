...
export const subjectsData = [
  { id: 1, name: "Matemáticas", teachers: ["Alice Phelps", "Russell Davidson"] },
  { id: 2, name: "Inglés", teachers: ["Manuel Becker", "Eddie Chavez"] },
  { id: 3, name: "Física", teachers: ["Lola Newman", "Darrell Delgado"] },
  { id: 4, name: "Química", teachers: ["Nathan Kelly", "Benjamin Snyder"] },
  { id: 5, name: "Biología", teachers: ["Alma Benson", "Lina Collier"] },
  { id: 6, name: "Historia", teachers: ["Hannah Bowman", "Betty Obrien"] },
  { id: 7, name: "Geografía", teachers: ["Lora French", "Sue Brady"] },
  { id: 8, name: "Artes", teachers: ["Harriet Alvarado", "Mayme Keller"] },
  { id: 9, name: "Música", teachers: ["Gertrude Roy", "Rosa Singleton"] },
  { id: 10, name: "Literatura", teachers: ["Effie Lynch", "Brett Flowers"] },
];
...
export const calendarEvents = [
  {
    title: "Matemáticas",
    allDay: false,
    start: new Date(2025, 6, 12, 8, 0), // Mes 6 = Julio
